...
/**
 * Used by Dagger to inject and instantiate new ViewModel objects
 */
public class ViewModelFactory implements ViewModelProvider.Factory {
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        ...
        if (provider == null)
            throw new IllegalArgumentException("Unable to instantiate ViewModel " + modelClass.getCanonicalName());
